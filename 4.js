...
function task4() {
  ...
  //функцію, яку потрібно викликати після певного часу, і час у мілісекундах (1000 мс = 1 с)
  // Після 1 секунди викликаємо функцію resolve, яка змінює стан проміса на "виконано"
  //і передає значення 'Проміс 1 виконано'
function promise1(){
  ...
  // Після 1 секунди викликаємо функцію resolve,
  //яка змінює стан проміса на "виконано" і передає значення 'Проміс 2 виконано'
