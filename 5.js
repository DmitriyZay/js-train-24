...
function task5() {
  ...
  intervalPromise
    ...
    // Використовуємо функцію setInterval,
    //щоб імітувати асинхронну операцію яка повторюється кожну секунду
    // збільшуючи лічильник на 1
    // Виводимо в консоль `Значення лічильника: ${counter}`
    // Коли лічильник досягає 5, використовуємо clearInterval та викликаємо resolve,
    //який повертає значення лічильника.
    .then((value) => {
      console.log(value);
    })

    // Використовуємо .then метод для отримання значення,
    //яке було передане у функцію resolve() в нашому промісі, та виводимо його в консоль.
  ...
  //в якому стані завершився наш проміс, та виводимо повідомлення "Завершення лічильника"
