...
function task1() {
  /**
   * Функція `getData` симулює отримання даних з асинхронного джерела,такого як запит
   * до бази даних або API.
   *
   *  data - вхідні дані.
  ...
  function getData(data, timeout = 2000) {
    ...
    // За допомогою setTimeout ми симулюємо затримку timeout, яка виникає при роботі
    //з асинхронними джерелами даних
  ...
  // Ми викликаємо getData з об'єктом { name: "John", age: 30, city: "New York" }
  //і часом очікування 2000
...
// Незалежно від того, завершилось виконання проміса успіхом чи ні виводимо в
//консоль "Завдання 1 завершено"
